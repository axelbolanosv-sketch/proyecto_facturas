...
def translate_column(language, column_name):
    ...
    return column_name# modules/translator.py
# VERSIÓN 13.0: TRADUCCIÓN COMPLETA (REGLAS, ORDENAR, VISTA, SELECCIÓN)
...
LANGUAGES = {
    "es": {
        ...
        "warning_select_cols": "Seleccione columnas para mostrar.",
    ...
    "en": {
        ...
        "sort_opt_max_min": "🔼 Max-Min",
        "sort_opt_min_max": "🔽 Min-Max",
        "warning_select_cols": "Select columns to display.",
